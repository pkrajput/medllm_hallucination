...
def vectorize_and_upload_pdf_content(index, embedding_model_name, textlist, openai_api_key):
    batch_size = 100
...
def process_pdf_file(start_idx=0):
    ...
    vectorize_and_upload_pdf_content(index, embedding_model_name, textlist[start_idx:], openai_api_key)
